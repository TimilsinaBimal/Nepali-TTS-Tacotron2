    ...
    def NumberToText(self, nepali_number):
        ...
        while wholePart > 99:
            ...
            if len(wholeNumberIntoCharArray) < 4:
                ...
                tensNumber = int(math.floor(float(wholePart/divisibleNumber)))
...
# num_to_word_obj = NumberToNepaliText()
# nepali_number = "४०२०००.४"
# print("Input: " + nepali_number)
# print("Result: " + num_to_word_obj.NumberToText(nepali_number))
